...
export const guideMeta: Record<Locale, { title: string; description: string }> = {
  ...
  ar: {
    title: "دليل تأشيرة بوليفيا كوسكו 2026 | المتطلبات والإجراءات – Conexión Bolivia",
    description:
      "هل تحتاج تأشيرة لدخول بوليفيا؟ دليل شامل: المتطلبات والمستندات وأوقات المعالجة في كوسكو وزيارة سالار دي أيويوني.",
  },
  he: {
    title: "מדריך ויזה לבוליביה קוסקו 2026 | דרישות ותהליך – Conexión Bolivia",
    description:
      "צריך ויזה לבוליביה? מדריך מלא: דרישות, מסמכים, זמני טיפול בקוסקו ואיך לבקר ב-Salar de Uyuni בלי סיבוכים.",
  },
  pt: {
...
export const guideContent: Record<Locale, GuideContent> = {
  ...
  zh: {
    ...
    stepsTitle: "4步获取签证",
    steps: [
      { title: "通过微信联系我们", text: "告诉我们您的国籍和旅行日期。我们将确认是否需要签证以及需要准备哪些材料。" },
    ...
    faqTitle: "玻利维亚签证常见问题",
    faqs: [
      { q: "进入玻利维亚需要签证吗？", a: "取决于您的国籍。来自中国、印度、印尼、塞尔维亚、乌克兰等许多国家的旅行者需要签证。通过微信联系我们，几分钟内即可确认。" },
      { q: "可以在秘鲁库斯科办理玻利维亚签证吗？", a: "可以。库斯科有玻利维亚领事馆，我们的办公室就在对面。对于乌尤尼盐沼旅行者来说，库斯科是路线上的自然中转站，最为便利。" },
      { q: "在库斯科办理签证需要多长时间？", a: "携带所有文件，约需30分钟。如提前通过微信或邮件发送文件，领取签证约需10分钟。" },
  ...
  "zh-tw": {
    ...
    stepsTitle: "4步取得簽證",
    steps: [
      { title: "透過微信聯絡我們", text: "告訴我們您的國籍和旅行日期。我們將確認是否需要簽證以及需要準備哪些文件。" },
    ...
    faqTitle: "玻利維亞簽證常見問題",
    faqs: [
      { q: "進入玻利維亞需要簽證嗎？", a: "取決於您的國籍。來自中國、印度、印尼、塞爾維亞、烏克蘭等許多國家的旅行者需要簽證。透過微信聯絡我們，幾分鐘內即可確認。" },
      { q: "可以在秘魯庫斯科辦理玻利維亞簽證嗎？", a: "可以。庫斯科有玻利維亞領事館，我們的辦公室就在對面。對於烏尤尼鹽沼旅行者來說，庫斯科是路線上的自然中轉站，最為便利。" },
      { q: "在庫斯科辦理簽證需要多長時間？", a: "攜帶所有文件，約需30分鐘。如提前透過微信或郵件發送文件，領取簽證約需10分鐘。" },
  ...
  he: {
    title: "מדריך מלא: ויזה לבוליביה בקוסקו",
    subtitle: "כל מה שצריך לדעת לפני ביקור ב-Salar de Uyuni",
    intro:
      "אלפי מטיילים מישראל, סין, אינדונזיה, הודו, סרביה ואוקראינה עוברים בקוסקו בדרך לבוליביה. המדריך הזה עונה על השאלות הנפוצות ביותר לגבי קבלת ויזה במהירות ובביטחון במשרד שלנו, מול הקונסוליה הבוליביאנית.",
    stepsTitle: "איך מקבלים ויזה ב-4 שלבים",
    steps: [
      {
        title: "צרו קשר ב-WhatsApp",
        text: "שלחו לנו את האזרחות ותאריכי הנסיעה. נאשר אם אתם צריכים ויזה ואילו מסמכים להכין.",
      },
      {
        title: "הכינו את המסמכים",
        text: "דרכון בתוקף, תמונה, מסלול נסיעה, הזמנת מלון, הוכחת יכולת כלכלית וחיסון קדחת צהובה אם נדרש.",
      },
      {
        title: "בקרו במשרד שלנו בקוסקו",
        text: "Clorinda Matto de Turner 308, מול הקונסוליה הבוליביאנית. אם שולחים מסמכים מראש, האיסוף לוקח ~10 דקות.",
      },
      {
        title: "קבלו ויזה וצאו לבוליביה",
        text: "עם ויזה מוכנה, המשיכו ל-Salar de Uyuni, ל-La Paz או לרמת בוליביה בלי עיכובים בגבול.",
      },
    ],
    faqTitle: "שאלות נפוצות על ויזה לבוליביה",
    faqs: [
      {
        q: "האם אני צריך ויזה כדי להיכנס לבוליביה?",
        a: "תלוי באזרחות. מטיילים ממדינות רבות — כולל ישראל, סין, הודו, אינדונזיה, סרביה ואוקראינה — זקוקים לויזה. כתבו לנו ב-WhatsApp עם פרטי הדרכון ונאשר תוך דקות.",
      },
      {
        q: "אפשר לקבל ויזה לבוליביה בקוסקו, פרו?",
        a: "כן. בקוסקו יש קונסוליה בוליביאנית והמשרד שלנו ממש מולה. זו האפשרות הנוחה ביותר למטיילים ל-Salar de Uyuni.",
      },
      {
        q: "כמה זמן לוקח התהליך בקוסקו?",
        a: "עם כל המסמכים, כ-30 דקות. אם שולחים מסמכים מראש ב-WhatsApp או בדוא״ל, האיסוף לוקח כ-10 דקות.",
      },
      {
        q: "אילו מסמכים נדרשים לויזת תיירות?",
        a: "בדרך כלל: דרכון בתוקף (לפחות 6 חודשים), תמונת דרכון על רקע לבן, מסלול נסיעה, הזמנת מלון, הוכחת יכולת כלכלית (דף חשבון) ותעודת חיסון קדחת צהובה אם נדרש.",
      },
      {
        q: "צריך ויזה לפני Salar de Uyuni?",
        a: "כן, אם האזרחות שלכם מחייבת. עדיף לטפל בזה בקוסקו לפני מעבר הגבול, כדי להימנע מעיכובים או סירוב ב-Desaguadero או Villazón.",
      },
      {
        q: "איפה הקונסוליה הבוליביאנית בקוסקו?",
        a: "בקוסקו, פרו. משרד Conexión Bolivia נמצא ב-Clorinda Matto de Turner 308, ממש מול הקונסוליה.",
      },
      {
        q: "אפשר לקבל ויזה באותו יום?",
        a: "כן, ברוב המקרים. הגיעו עם כל המסמכים ונלווה אתכם באותו יום.",
      },
      {
        q: "למה בקוסקו ולא בגבול?",
        a: "בקוסקו מקבלים ליווי אישי, בדיקת מסמכים מראש ותהליך מהיר ובטוח יותר. בגבול אין ייעוץ וטעויות עלולות לעלות ביוקר.",
      },
    ],
    ctaTitle: "מוכנים לויזה?",
    ctaText: "כתבו לנו ב-WhatsApp ונלווה אתכם צעד אחר צעד. מענה מיידי.",
  },
};
